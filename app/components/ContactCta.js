...
export default function ContactCTA({ contactCtaData, physicalAddresses, phoneNumbers, emails }) {
    ...
    return (
        <div id="contact" className="relative bg-red-500 pt-32">
            ...
            <div id="contact-form" className="max-w-7xl mx-auto px-6">
                
            </div>
            <div className="flex flex-wrap items-center max-w-7xl mt-12 sm:-mt-16 mx-auto px-6 text-white text-lg">
            ...
            <img src="https://inside.tandoorandtap.com/wp-content/uploads/2022/10/orange-border.svg" className="pt-16 md:pt-24 w-full home-hero-border" />
        </div>
    );
}