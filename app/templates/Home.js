    ...
    return (
        <>
            ...
            <div className="bg-orange-500 pt-40 3xl:pt-48 overflow-hidden">
                <div className="relative max-w-6xl mx-auto py-32 hero" style={{backgroundImage: `url(` + homeHeroImg + `)`}}>
                    ...
                    <h1 className="relative max-w-sm md:max-w-lg text-6xl sm:text-7xl md:text-8xl text-white text-center leading-none uppercase tracking-wide mx-auto p-4 z-30 hero-title">{pageData.acf.hero_section.title}</h1>
            ...
            <div className="bg-yellow-500 py-12 md:py-32 overflow-hidden">
                <div className="grid md:grid-cols-12 items-center max-w-6xl mx-auto px-6 xl:px-0">
                    ...
                    <div className="order-1 md:order-2 relative col-span-7 w-full pb-12 xl:py-80">
                        <img className="xl:hidden w-full sm:w-2/3 md:w-full mx-auto" src="https://inside.tandoorandtap.com/wp-content/uploads/2022/10/mobile-menu-cta-section.png" />
                        <img className="hidden xl:block absolute top-0 left-0 -mt-12 -ml-12 z-20" src="https://inside.tandoorandtap.com/wp-content/uploads/2022/10/red-dots.svg" />
                        <img className="hidden xl:block absolute top-0 left-0 z-30" src={pageData.acf.menu_cta_section.image_left.url} />
                        <img className="hidden xl:block absolute bottom-0 right-0 z-20" src={pageData.acf.menu_cta_section.image_right.url} />
                        <img className="hidden xl:block absolute bottom-0 right-0 -mb-12 -mr-12" src="https://inside.tandoorandtap.com/wp-content/uploads/2022/10/red-dots.svg" />
                    </div>
                </div>
            </div>
            <div className="bg-egg py-32 md:py-40">
                <div className="grid md:grid-cols-12 items-center max-w-6xl mx-auto px-6 xl:px-0">
                    ...
                    <div className="order-1 md:order-2 relative col-span-12 md:col-span-5 w-full pb-12 md:pb-0">
                        <img className="absolute top-0 bottom-0 left-0 -ml-48" src="https://inside.tandoorandtap.com/wp-content/uploads/2022/10/about-decoration-img.svg" />
                        <img className="w-full sm:w-2/3 md:w-full rounded-md mx-auto" src={pageData.acf.about_section.image.url} />
                    </div>
                </div>
            </div>
        </>
